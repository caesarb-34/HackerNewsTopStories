...
// Created: 5/5/2011 3:22:16 PM

function WebTrends() {
  var that = this;
  // begin: user modifiable
  this.dcsid = "dcsdxiztc6qvsn0g8xfv39lji_1f6p";
  this.domain = "sdc.standard.com";
  this.timezone = -8;
  this.fpcdom = ".standard.com";
  this.onsitedoms = "www.standard.com";
